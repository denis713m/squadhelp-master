export default {
    ...
    GET_TOTAL_TRANSACTIONS_REQUEST: 'GET_TOTAL_TRANSACTIONS_REQUEST',
    GET_TOTAL_TRANSACTIONS_SUCCESS: 'GET_TOTAL_TRANSACTIONS_SUCCESS',
    GET_TOTAL_TRANSACTIONS_ERROR: 'GET_TOTAL_TRANSACTIONS_ERROR',
    MAKE_TRANSACTION: 'MAKE_TRANSACTION',
    MAKE_TRANSACTION_REQUEST: 'MAKE_TRANSACTION_REQUEST',
    MAKE_TRANSACTION_SUCCESS: 'MAKE_TRANSACTION_SUCCESS',
    MAKE_TRANSACTION_ERROR: 'MAKE_TRANSACTION_ERROR',
    GET_EVENTS: 'GET_EVENT',
    GET_EVENTS_SUCCESS: 'GET_EVENT_SUCCESS',
    GET_EVENTS_ERROR: 'GET_EVENT_ERROR',
    DELETE_EVENT: 'DELETE_EVENT',
    DELETE_EVENT_SUCCESS: 'DELETE_EVENT_SUCCESS',
    ADD_EVENT: 'ADD_EVENT',
    EVENT_ERROR: 'EVENT_ERROR',
    ADD_EVENT_SUCCESS: 'ADD_EVENT_SUCCESS',
    AUTH_ACTION_UPDATE_PASSWORD: 'UPDATE_PASSWORD',
    GET_OFFERS: 'GET_OFFERS',
    GET_OFFERS_REQUEST: 'GET_OFFERS_REQUEST',
    GET_OFFERS_SUCCESS: 'GET_OFFERS_SUCCESS',
    GET_OFFERS_ERROR: 'GET_OFFERS_ERROR',
    LOG_OUT: 'LOG_OUT',
    MODERATOR_CHANGE_OFFER_ACTION: 'MODERATOR_CHANGE_OFFER_ACTION',
    MODERATOR_CHANGE_OFFER_ERROR: 'MODERATOR_CHANGE_OFFER_ERROR',
    MODERATOR_CHANGE_OFFER_SUCCESS: 'MODERATOR_CHANGE_OFFER_SUCCESS',
    UPDATE_PASSWORD_AND_GET_USER: 'UPDATE_PASSWORD_AND_GET_USER',
}