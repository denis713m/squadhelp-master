    ...
    return (
        <>
                ...
                <div className={styles.stepsWraper}>
                    ...
                    <div className={styles.stepsContainer}>
                        <div className={styles.stepContainer}>
                            ...
                            <div className={styles.step}>Complete our fast, easy project brief template, and we’ll share
                        ...
                        <div className={styles.stepContainer}>
                            ...
                            <div className={styles.step}>You will start receiving name ideas - created specifically for
                                you - within minutes. Dozens of contestants work for you at the same time! A typical
                                naming contest receives several hundred name ideas. All ideas are automatically checked
                        ...
                        <div className={styles.stepContainer}>
                            ...
                            <div className={styles.step}>See all your submissions from your contest dashboard. Rate
                                entries, leave private comments, and send public messages, leading the process towards
                                the perfect name.
                            </div>
                        </div>
                        <div className={styles.stepContainer}>
                            ...
                            <div className={styles.step}>Choose your name with confidence. Our unique validation process
                        ...
                        <div className={styles.stepContainer}>
                            ...
                            <div className={styles.step}>Once your contest ends, announce the winner - and register the
                                name. Come back to Squadhelp to launch a Logo Design or Tagline project for your name.
                            </div>
                        </div>
                ...
                <div className={styles.questionsContainer}>
                    ...
                    <div className={styles.questionContainer}>
                        ...
                        <div className={styles.question}>
                            ...
                            However,
                            Squadhelp builds great brands that succeed faster by connecting you with the most creative
                            people across the globe. Most importantly, Squadhelp provides you with choice: you get to
                            see
                            ideas from dozens (in some cases, hundreds) of contestants before you select a winner.
                            Typically, you would spend far less money with Squadhelp (our contests start at $199) than
                            hiring an agency. Also, you will receive immediate results - most contests begin receiving
                    ...
                    <div className={styles.questionContainer}>
                        ...
                        <div className={styles.question}>
                            Since 2011, we have been committed to disrupting the traditional agency model. Our platform
                        ...
                        <div className={styles.question}>
                            <strong>Breadth:</strong> Our Contest-Based Crowdsourcing approach allows you to receive an
                            unmatched breadth of
                            name ideas from dozens of unique, creative minds while working with the world's largest
                            branding
                            community.
                        </div>
                        <div className={styles.question}>
                            ...
                            receive more ideas from our top-quality creatives, and we use Gamification best practices to
                        ...
                        <div className={styles.question}>
                            ...
                            high-end validation
                            services. Poll your target demographics to get unbiased feedback on your favorite names, and
                            receive Trademark Risk and Linguistics Analysis Reports developed by a Licensed Trademark
                            Attorney.
                        </div>
                    </div>
                    <div className={styles.questionContainer}>
                        ...
                        <div className={styles.question}>
                            Yes! We believe that validating and securing your name is a critical part of your branding
                            ...
                            <a className={styles.questionHref} href='https://www.squadhelp.com/brand-name-testing'>professional
                                audience testing</a>&nbsp;
                    ...
                    <div className={styles.questionContainer}>
                        ...
                        <div className={styles.question}>
                            Most customers tell us that Squadhelp’s process is effective, easy, fast, and even fun. We
                            constantly hear &nbsp;
                            ...
                            each contest, and many customers are surprised at how insightful working with dozens of
                            creative
                    ...
                    <div className={styles.questionContainer}>
                        ...
                        <div className={styles.question}>
                            You can host competitions for Naming, Taglines, Logos, Business cards, Package design, other
                    ...
                    <div className={styles.questionContainer}>
                        ...
                        <div className={styles.question}>
                            Our creatives work extremely hard to ensure a successful outcome for all projects. If you do
                            not
                            like any of the submissions, we can add more days to your contest at no extra cost. In
                            addition,
                            our Gold and Platinum Packages come with a partial refund option. If you do not like the
                            quality
                            of submissions, you can request a refund for the contest award fees (if you keep your
                            contest
                            award as "Not Guaranteed"). We also offer complimentary branding consultation to ensure you
                            get
                    ...
                    <div className={styles.questionContainer}>
                        ...
                        <ul className={styles.questionUl}>
                            <li className={styles.questionLi}>
                                - &nbsp;<a to='https://www.squadhelp.com/Name-Ideas' className={styles.questionHref}>Name
                                Examples</a>
                            </li>
                            <li className={styles.questionLi}>
                    ...
                    <div className={styles.questionContainer}>
                        ...
                        <div className={styles.question}>
                            Thousands of customers have used Squadhelp to find great Names, Taglines and Logos for their
                    ...
                    <div className={styles.questionContainer}>
                        ...
                        <div className={styles.question}>
                            Our disruptive approach to naming and branding has been used successfully by just about
                            every
                            type of venture imaginable. Startups and small businesses love our affordable pricing, SM&B
                            gravitate towards our end-to-end service, and large international businesses are
                            particularly
                            excited by the breadth of ideas and the rapid results. We have also worked with nonprofits,
                    ...
                    <div className={styles.questionContainer}>
                        ...
                        <div className={styles.question}>
                            We are an open platform built on the core belief that anyone can have a great idea. However,
                    ...
                    <div className={styles.questionContainer}>
                        ...
                        <div className={styles.question}>
                            Our naming competitions start at $199, and our logo design competitions start at $299. Also,
                            there are three additional contest level that each offer more features and benefits. See
                            our&nbsp;
                            <Link to='/squadhelp-pricing' className={styles.questionHref}>Pricing Page</Link>&nbsp;for
                            details.
                        </div>
                    </div>
                    <div className={styles.questionContainer}>
                        ...
                        <div className={styles.question}>
                            ...
                            bundle.
                            Bundles allow you to purchase multiple contests at one time and save as much as from $75 -
                            $400.
                    ...
                    <div className={styles.questionContainer}>
                        ...
                        <div className={styles.question}>
                            ...
                            to
                            read your project brief and participate in the contest. The contest details will be kept
                            private
                    ...
                    <div className={styles.questionContainer}>
                        ...
                        <div className={styles.question}>
                            Absolutely. Squadhelp services organizations across the globe. Our customer come from many
            ...
            <div className={styles.intercom}>
                <svg xmlns="http://www.w3.org/2000/svg" focusable="false" viewBox="0 0 28 32" className={styles.interComIco}>
